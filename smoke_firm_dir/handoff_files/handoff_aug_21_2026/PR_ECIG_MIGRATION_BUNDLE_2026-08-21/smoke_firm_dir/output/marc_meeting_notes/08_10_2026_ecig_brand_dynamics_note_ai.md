---
title: "E-Cigarette Market Structure: Brand Concentration, Entry/Exit, and Ownership"
subtitle: "Annual brand composition and concentration, the corporate history behind the leadership turnover, and the underlying mL-weighted price and nicotine series"
date: "August 10, 2026"
geometry: margin=1in
fontsize: 11pt
---
...
<style>
h2 { page-break-before: always; brcaneak-before: page; }
h2:first-of-type { page-break-before: avoid; break-before: avoid; }
body { font-size: 11pt; }
</style>

**August 10 revision.** All nicotine figures and statistics in this version use the
corrected nicotine panel. The correction removes a cartridge-scaling error that
understated delivered nicotine for multi-pod packs, especially VUSE Alto in 2021–2023.
It changes the interpretation of VUSE: VUSE was not winning with unusually low
nicotine. It was a high-nicotine pod, close to JUUL; its rise is instead a story of
JUUL's retreat, Alto's timing, and Reynolds/BAT distribution and trade execution.
...
<div align="center">
<img src="closed_pod_sm.png" />
<img src="disposable_sm.png" />
<img src="open_refill_sm.png" />
<br/>
...
| 2017 | MISTIC | 20.8% | BLU    | 56.1% | 1432 |
| 2018 | JUUL   | 47.9% | MARKTEN | 68.6% | 2701 |
| 2019 | JUUL   | 45.1% | NJOY   | 82.0% | 2873 |
| 2020 | JUUL   | 34.8% | VUSE   | 90.0% | 2773 |
...
- **2018–2020 (JUUL).** JUUL re-concentrates the market; HHI returns above 2,500 and
  JUUL reaches about 48% of tracked mL in 2018 and 45% in 2019.
- **2021–2023 (VUSE/JUUL duopoly).** VUSE overtakes JUUL; the top two hold roughly
  72–75% of tracked mL, CR3 is roughly 87–88%, and HHI climbs to ~3,550 — highly
  concentrated again.
...
| MarkTen | **Altria** (Nu Mark) | ~11% (2018) → discontinued 2018 |
...
| JUUL | independent; **Altria** 35% stake (Dec 2018, \$12.8B; exited 2023) | leader 2018–20 (peak ~48%) → declining #2 |
...
category and took the tracked lead in 2018 (~48% of mL, and a far higher share of the
...
process — which is why MarkTen appears at ~11% in 2018 and then vanishes. JUUL's decline
...
The corrected nicotine data sharpen this interpretation. VUSE Alto's leading pods are
roughly **41 mg/mL labeled nicotine and 28 mg/mL delivered** on a brand-volume-weighted
basis in 2021–2023, versus roughly **50 mg/mL labeled and 34 mg/mL delivered** for JUUL.
The prior appearance of VUSE at only ~16–17 delivered mg/mL came from treating a
multi-pod pack's nicotine yield as though it covered the whole pack volume. Correcting
that error moves VUSE into the same high-nicotine product class as JUUL. Therefore,
nicotine does not explain why VUSE displaced JUUL: VUSE did not win by offering a
low-nicotine alternative, and the concentration ranking does not change when nicotine
is repaired.
...
content is the analogous mL-weighted object, $N_{\text{hom}}$. For each product, the
corrected delivered nicotine is built from the identity
$\text{total mL}\times\text{clean label mg/mL}\times 0.68$ transfer efficiency, then
aggregated using the same mL weights. Because cartridge count appears in both total
nicotine and total liquid, it cancels from delivered concentration; this avoids the
multi-cartridge scaling error in the prior panel.
...
**2021–2023 (VUSE and modern disposables).** Corrected closed-pod delivered
concentration is broadly flat, easing only from about 29.7 to 28.5 mg/mL, while average
capacity rises from about 4.2 to 5.0 mL; closed-pod $N_{\text{hom}}$ therefore rises
from about 125 to 142 mg. Within disposables, concentration also eases slightly
(32.1→30.4 mg/mL), but size rises sharply (3.4→4.9 mL), pushing disposable
$N_{\text{hom}}$ from about 108 to 150 mg. Thus the post-2021 increase is predominantly
a size/pack and product-mix channel, not increasing nicotine concentration. But see
Appendix B — disposables remain underrepresented in tracked volume, so the pooled
series remains pod-dominated.

In the corrected pooled endpoint decomposition (2013→2023),
$\Delta P_{\text{hom}}=-\$4.2$ (price-intensity $-\$9.3$, size $+\$7.9$,
interaction $-\$2.8$). $\Delta N_{\text{hom}}=+94.0$ mg: concentration contributes
+60.6 mg, size +15.0 mg, and their interaction +18.4 mg. For the modern 2018→2023
period, however, size is the dominant nicotine channel (+36.1 of the +50.7 mg total).
...
![Repeated for readability: the two nicotine measures from the national series — nicotine concentration (mg/mL) and $N_{\text{hom}}$ — by product type (pooled = dashed red).](../prelim_analysis/p_and_n_decomp_t2/national_monthly_series_nicotine.png)
...
- **2016–2017 (salts begin, pods shrink).** LOGIC climbs to second; nicotine
  concentration rises (17.1→19.4 mg/mL) while capacity falls (3.9→3.3 mL) as small pods
...
- **2018–2019 (JUUL).** JUUL takes roughly half then the mid-40s percent of
  pod+disposable mL; concentration jumps (19.4→29.8 mg/mL) and capacity falls to
  ~2.8–2.9 mL as small pods dominate; $N_{\text{hom}}$ rises 64→88. Crucially, with
  open refill excluded there is **no mid-2019
  bump** — the spurious pooled-series blip in §4 was entirely an open-refill clearance
  artifact, and it vanishes here.
- **2020 (regulation splits the market).** JUUL still leads (~35%) but VUSE closes to
  ~29%; nicotine plateaus (~30 mg/mL), capacity begins rising again;
  $N_{\text{hom}}$ is ~94. See the timeline in §6.
- **2021–2023 (VUSE/JUUL duopoly, modern disposables).** VUSE leads (44%→55%), JUUL
  is second; capacity rises sharply (4.1→5.0 mL), while corrected concentration is
  nearly flat (30.0→28.9 mg/mL). $N_{\text{hom}}$ consequently climbs from about
  123 to 143 mg, overwhelmingly through the size/product-mix channel; price/mL settles
  near \$4.4 and $P_{\text{hom}}$ recovers ~19→22.

Excluding open refill, the corrected 2013→2023 endpoint changes are
$\Delta P_{\text{hom}}=-\$5.2$ and $\Delta N_{\text{hom}}=+91.5$ mg (versus
about +94.0 mg with open refill). The closed-product result is therefore not driven by
the volatile bottled-juice series.
...
The standardized definition raises the RMS disposable share materially — from 7.6% to
14.4% in January 2020, and from 21.3% to 30.6% in December 2022 — closing roughly 30–40%
of the gap to the CDC/IRI points (24.7% and 51.8%). The residual gap (14.4 vs 24.7;
