## Recreate ALL decompose_p_and_n.R outputs, but on the corrected T2 panel
## (bt_month_t2, built by build_t2_panel.R: overrides, exclusions, imputation,
## HAUS->MISTIC, etc.). This is the POOLED "homogeneous e-cigarette" view
...
output_dir <- file.path(firm_dir, "output", "prelim_analysis", "p_and_n_decomp_t2")
